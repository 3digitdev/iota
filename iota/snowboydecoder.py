...
class HotwordDetector(object):
    ...
    :param decoder_model: decoder model file path (string or a list of strings)
    ...
    def start(self, detected_callback=None,
        ...
        :param audio_recorder_callback: if specified, this will be called after
                                        ...
                                        has been recorded. The function will be
        ...
        while self._running is True:
            ...
            if state == "PASSIVE":
                if status > 0:  # key word found
                    ...
                    silentCount = 0
                    recordingCount = 0
                    message = f"Keyword {status} detected at time: "
